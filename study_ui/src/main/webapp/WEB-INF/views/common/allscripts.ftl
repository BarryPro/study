...
<!-- tags -->
<script src="/static/js/tags/jquery.tagsinput.min.js"></script>
<!-- switchery -->
...
<!-- richtext editor -->
<script src="/static/js/editor/bootstrap-wysiwyg.js"></script>
<script src="/static/js/editor/external/jquery.hotkeys.js"></script>
<script src="/static/js/editor/external/google-code-prettify/prettify.js"></script>
<!-- select2 -->
...
<!-- textarea resize -->
<script src="/static/js/textarea/autosize.min.js"></script>
<script>
    autosize($('.resizable_textarea'));
  </script>
<!-- Autocomplete -->
<script type="text/javascript" src="/static/js/autocomplete/countries.js"></script>

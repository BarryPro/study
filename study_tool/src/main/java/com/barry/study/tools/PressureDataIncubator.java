...
public class PressureDataIncubator {
    ...
    public static void main(String[] args) {
        ...
        // 生成多少条数据
        int size = 1000000;
        incubator.genPressureData(size, true,"/Users/yuchenglong03/tmp/supplierPressureDataZL100W.csv");
        FileUtil.readFile("/Users/yuchenglong03/tmp/supplierPressureDataZL100W.csv");
    }
}
